...
public class JobApiTest {
	...
	public void createjobPost() throws Exception {
		Json json = cases.get("createjobpost");
		test(json);
	}
	@Test
	public void createjobpostsad() throws Exception {
		Json json = cases.get("createjobpostsad");
		test(json);
	}
	@Test
	public void createjoblocations() throws Exception {
		Json json = cases.get("createjoblocations");
		test(json);
	}
	@Test
